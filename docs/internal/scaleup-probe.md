...
These notes record the throughput and sizing probes that informed the accepted
...
- The accepted training shape is `configs/pretrain_214m_b200.json`.
...
- The accepted run uses a 32,768-token vocabulary, context length 1024, and the
